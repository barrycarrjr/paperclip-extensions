 ...
 * runtime deps (@slack/web-api transitive CJS modules) use dynamic `require()`
 * calls that don't resolve in plain ESM. The banner polyfills `require`
 * against the worker's import.meta.url so the bundled CJS code works at
 * runtime.
 */
